...
var (
	//go:embed test_data/noClaims.json
	noClaimsPayload []byte
	//go:embed test_data/k8sMultiAudPayload.json
	k8sMultiAudPayload []byte
	//go:embed test_data/k8sNoServiceAccountPayload.json
	k8sNoServiceAccountPayload []byte
	//go:embed test_data/k8sNoServiceAccountIdPayload.json
	k8sNoServiceAccountIdPayload []byte
	//go:embed test_data/k8sNoServiceAccountNamePayload.json
	k8sNoServiceAccountNamePayload []byte
	//go:embed test_data/k8sNoPodPayload.json
	k8sNoPodPayload []byte
	//go:embed test_data/k8sNoPodIdPayload.json
	k8sNoPodIdPayload []byte
	//go:embed test_data/k8sNoPodNamePayload.json
	k8sNoPodNamePayload []byte
	//go:embed test_data/k8sNoNodePayload.json
	k8sNoNodePayload []byte
	//go:embed test_data/k8sNoNodeIdPayload.json
	k8sNoNodeIdPayload []byte
	//go:embed test_data/k8sNoNodeNamePayload.json
	k8sNoNodeNamePayload []byte
	//go:embed test_data/k8sNoNamespacePayload.json
	k8sNoNamespacePayload []byte
	//go:embed test_data/k8sPayload.json
	k8sPayload []byte
)
